...
class PlaceClientClass(object):
    ...
    def __init__(self):
        ...
        # TODO change to more sensitive values
        self.pre_release = [-0.5, -0.26, -0.37, -2.56, -0.13, 2.32, 0.52]
        self.release = [-0.0, 0.23, -0.089, -2.59, 0.02, 2.824, 0.478]
